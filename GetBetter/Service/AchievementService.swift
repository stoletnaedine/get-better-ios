...
class AchievementService {
    ...
    func saveStartAchievements() {
        ...
        let regularSeven = Achievement(id: "regular7", icon: "🤘", title: "Неделя ок", description: "Добавлять по 1 событию 7 дней подряд", unlocked: false)
        ...
        let finishTen = Achievement(id: "finish10", icon: "🏆", title: "ПРОКАЧАНО", description: "Прокачать Сферу до 10 баллов", unlocked: false)
