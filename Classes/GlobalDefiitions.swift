...
struct GlobalDefiitions {
    ...
    struct AboutCircle {
        ...
        static let description = "Смысл в том, что колесо должно катиться.\nЧтобы колесо стало круглым, нужно выровнять значения — уменьшить важность одного или сделать что-то для увеличения значения других сфер. Регулярно ведите записи в разделе Дневник. Так вы наглядно увидите результаты."
    }
