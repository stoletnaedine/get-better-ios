...
class TipStorage {
    ...
    private let tipsRaw: [Tip] = [
        ...
        Tip(title: "Учись говорить «НЕТ»",
            text: "Не бойтесь отказывать!\n— Не желаете ли совершить визит вежливости?\n– Нет!"),
        Tip(title: "Оценивайте свои слова",
            text: "Оценивайте каждое произносимое слово на правдивость, полезность и доброту. Говорите только по сути, ничего лишнего. Нет сплетням, лжи и жалобам! Лучше молчите, если нечего сказать."),
        Tip(title: "Думайте",
        ...
        Tip(title: "Принцип харизмы",
            text: "Искренне интересуйтесь людьми, ведь чаще всего мы проявляем интерес к тому человеку, который интересуется нами."),
        ...
        Tip(title: "Принцип 100 баллов",
            text: "Когда вы видите в человеке больше положительного, чем отрицательного и верите в его лучшие качества, вы «заставляете» его проявлять их."),
        ...
        Tip(title: "Принцип доступности",
            text: "Когда человеку легко с самим собой, другие тоже чувствуют себя легко и свободно с ним. Отношения с самим собой отражает отношение к нам других людей."),
        ...
        Tip(title: "Cтань исследователем собственной жизни",
            text: "Постарайтесь всегда и во всем занимать позицию исследователя. Пока вы в сознании, никто и ничто не сможет отнять у вас эту возможность."),
        Tip(title: "О поддержке просить не стыдно!",
            text: "Как же важно уметь не только найти поддержку, но и принять ее. Решитесь попросить о помощи, и вы удивитесь, насколько ваша жизнь изменится. Получая поддержку, мы становимся сильнее!"),
        Tip(title: "Будьте благодарны искренне",
            text: "Никто никому ничего не должен. Везде — наш собственный выбор. С проистекающей отсюда свободой и ответственностью."),
        Tip(title: "Потанцуйте сегодня",
            text: "Без музыки. Без повода. Без партнёра. Или с партнёром! Танцы не займут много времени, но точно украсят этот день."),
        Tip(title: "Не давайте советов",
            text: "Жизнь — коллекция опытов, и самый главный из них — находить новые возможности внутри себя и преодолевать себя. Делитесь советом только, если об этом просят."),
        Tip(title: "Начните двигаться к цели, используя то, что есть",
            text: "Отличай ложные цели от истинных. У тебя уже есть все, чтобы начать двигаться в нужном направлении."),
        Tip(title: "Не переедайте на ночь",
            text: "Организму не придется тратить силы на переваривание пищи во время сна, и вы отдохнете лучше и быстрее."),
        Tip(title: "Делайте зарядку",
            text: "Пятнадцать минут на самые простые упражнения. Так вы быстрее проснетесь."),
        Tip(title: "Не бойтесь повторяться!",
            text: "Знаменитый фотограф Картье-Брессон говорил, что его первые 10 000 снимков были самыми плохими. И сделать хорошие можно только одним способом: сперва делать плохие. И не останавливаться."),
        Tip(title: "Счастье любит тишину",
            text: "Подробная трансляция своей жизни в соцсетях может породить завистников и недоброжелателей. Тщательно выбирайте, чем и с кем вы хотите поделиться."),
        Tip(title: "Следите за речью",
            text: "Лучше промолчать, если нечего сказать. Избегайте слов-паразитов. Формулируйте мысль, прежде чем ее высказать. Ваш собеседник точно оценит это."),
        Tip(title: "Наполняй реку по капле",
            text: "Вкладывай энергию, средства и мысли только в ту цель, которая принесет тебе удовлетворение. Проси тех, кто уже проходил этот путь, рассказать о своих открытиях и провалах."),
        Tip(title: "Нарисуйте свой счастливый день",
            text: "Найдите время и спокойное место, и опишите свой идеальный день в будущем. Это даст понять, чего вы действительно сейчас хотите."),
        Tip(title: "Не спешите с выводами",
            text: "Если есть возможность узнать причину того, что происходит — уточните. Не принимайте поспешных решений, не решайте за других."),
        Tip(title: "И это пройдёт",
            text: "Если у вас сейчас всё хорошо. Или всё идёт не так, как хотелось бы. Помните одну простую вещь — и это пройдёт."),
        Tip(title: "Скажите нет лишней информации",
            text: "Если вы не управляете новостями, которые доходят до вас, значит, они управляют вами."),
        Tip(title: "Выбирайте коллег по душе",
            text: "Работайте только с теми людьми, с кем вы хотели бы после работы выпить чай или кофе."),
        Tip(title: "Не держите гаджеты в спальне",
            text: "Тогда вам будет просто лень за ним идти, и вы будете отдыхать (чем и нужно заниматься в спальне)."),
        Tip(title: "Записывайте дела на будущее",
            text: "Если вы вспомнили, что нужно что-то сделать, запишите это в Напоминания телефона. И когда на это будет время, займитесь этим списком."),
        Tip(title: "Устраивайте себе «социальный» детокс",
            text: "Это снижает влияние бессмысленного «социального белого шума» в голове."),
        Tip(title: "Помните, что ваши профили в соцсетях — это ваш интернет-портрет",
            text: "Следите за тем, что и как вы публикуете."),
        Tip(title: "Попробуйте работать стоя",
            text: "Это полезно для тела, но долго стоять не очень удобно, поэтому вы будете более эффективно и продуктивно работать, чтобы можно было отойти от стола и немного передохнуть."),
        Tip(title: "Обучайте других, рассказывайте сообществу то, о чём знаете",
            text: "Обучая других, мы сами учимся. Выступление поможет преодолеть страхи, научиться умению говорить перед аудиторией, научиться быстро соображать, отвечая на вопросы."),
        Tip(title: "Отсекайте лишнее",
            text: "Удаляйте неиспользуемые программы, ненужные профили в соцсетях и проектах, ненужные контакты в телефоне, отписывайтесь от ненужных сервисов. Всё, что вы не используете, тормозит вас."),
        Tip(title: "Держите рабочее место в порядке",
            text: "Порядок в голове начинается с порядка в окружающем пространстве."),
        Tip(title: "Не забывайте отдыхать",
            text: "Если не выделять для работы строго определённое время, есть риск превратить свою жизнь в постоянную работу."),
        Tip(title: "Учитесь новому",
            text: "Это позволит смотреть на свои задачи шире и находить нестандартные решения."),
        Tip(title: "Не будьте равнодушным и циничным",
            text: "Это хорошо для героев сериалов, но реальная жизнь многомернее любого сериала.")
    ]
}
